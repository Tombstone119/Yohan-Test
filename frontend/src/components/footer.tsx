...
export default function Footer() {
  return (
    <div className=" footer flex justify-evenly items-center px-5 py-10  bg-black text-red-600 flex-wrap">
      <div className="flex flex-col gap-5 w-[50%] footercont">
        <h3 className="flex gap-2 font-bold text-2xl text-red-500 items-center ">
          Fit-Track Fitness <GiWeightLiftingUp />
        </h3>
        <p>
      ...
      <div className="border-t border-gray-800 mt-12 pt-8 text-center">
        <p className="text-gray-600">
          © {new Date().getFullYear()} Fit-Track Fitness. All rights reserved.
        </p>
      </div>
    </div>
  );
